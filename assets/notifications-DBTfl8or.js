...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Nt,depthTest:!1,depthWrite:!1})}function Wg(t,e,n){const i=new Float32Array(ri),r=new B(0,1,0);return new Ct({name:"SphericalGaussianBlur",defines:{n:ri,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${t}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:ss(),fragmentShader:`
	...
	`}class qc extends bt{constructor(e=1,n={}){super(e,e,n),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},r=[i,i,i,i,i,i];this.texture=new Hc(r),this._setTextureOptions(n),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,n){this.texture.type=n.type,this.texture.colorSpace=n.colorSpace,this.texture.generateMipmaps=n.generateMipmaps,this.texture.minFilter=n.minFilter,this.texture.magFilter=n.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new dr(5,5,5),s=new Ct({name:"CubemapFromEquirect",uniforms:Oi(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:Bt,blending:Nt});s.uniforms.tEquirect.value=n;const a=new Zt(r,s),o=n.minFilter;return n.minFilter===si&&(n.minFilter=vt),new Kh(1,10,this).update(e,a),n.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,n=!0,i=!0,r=!0){const s=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(n,i,r);e.setRenderTarget(s)}}function Xg(t){let e=new WeakMap,n=new WeakMap,i=null;function r(u,h=!1){return u==null?null:h?a(u):s(u)}function s(u){if(u&&u.isTexture){const h=u.mapping;if(h===us||h===ds)if(e.has(u)){const g=e.get(u).texture;return o(g,u.mapping)}else{const g=u.image;if(g&&g.height>0){const S=new qc(g.height);return S.fromEquirectangularTexture(t,u),e.set(u,S),u.addEventListener("dispose",c),o(S.texture,u.mapping)}else return null}}return u}function a(u){if(u&&u.isTexture){const h=u.mapping,g=h===us||h===ds,S=h===oi||h===Ui;if(g||S){let m=n.get(u);const p=m!==void 0?m.texture.pmremVersion:0;if(u.isRenderTargetTexture&&u.pmremVersion!==p)return i===null&&(i=new _l(t)),m=g?i.fromEquirectangular(u,m):i.fromCubemap(u,m),m.texture.pmremVersion=u.pmremVersion,n.set(u,m),m.texture;if(m!==void 0)return m.texture;{const A=u.image;return g&&A&&A.height>0||S&&A&&l(A)?(i===null&&(i=new _l(t)),m=g?i.fromEquirectangular(u):i.fromCubemap(u),m.texture.pmremVersion=u.pmremVersion,n.set(u,m),u.addEventListener("dispose",d),m.texture):null}}}return u}function o(u,h){return h===us?u.mapping=oi:h===ds&&(u.mapping=Ui),u}function l(u){let h=0;const g=6;for(let S=0;S<g;S++)u[S]!==void 0&&h++;return h===g}function c(u){const h=u.target;h.removeEventListener("dispose",c);const g=e.get(h);g!==void 0&&(e.delete(h),g.dispose())}function d(u){const h=u.target;h.removeEventListener("dispose",d);const g=n.get(h);g!==void 0&&(n.delete(h),g.dispose())}function f(){e=new WeakMap,n=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:r,dispose:f}}function Yg(t){const e={};function n(i){if(e[i]!==void 0)return e[i];const r=t.getExtension(i);return e[i]=r,r}return{has:function(i){return n(i)!==null},init:function(){n("EXT_color_buffer_float"),n("WEBGL_clip_cull_distance"),n("OES_texture_float_linear"),n("EXT_color_buffer_half_float"),n("WEBGL_multisampled_render_to_texture"),n("WEBGL_render_shared_exponent")},get:function(i){const r=n(i);return r===null&&za("WebGLRenderer: "+i+" extension not supported."),r}}}function Qg(t,e,n,i){const r={},s=new WeakMap;function a(f){const u=f.target;u.index!==null&&e.remove(u.index);for(const g in u.attributes)e.remove(u.attributes[g]);u.removeEventListener("dispose",a),delete r[u.id];const h=s.get(u);h&&(e.remove(h),s.delete(u)),i.releaseStatesOfGeometry(u),u.isInstancedBufferGeometry===!0&&delete u._maxInstanceCount,n.memory.geometries--}function o(f,u){return r[u.id]===!0||(u.addEventListener("dispose",a),r[u.id]=!0,n.memory.geometries++),u}function l(f){const u=f.attributes;for(const h in u)e.update(u[h],t.ARRAY_BUFFER)}function c(f){const u=[],h=f.index,g=f.attributes.position;let S=0;if(g===void 0)return;if(h!==null){const A=h.array;S=h.version;for(let M=0,T=A.length;M<T;M+=3){const R=A[M+0],b=A[M+1],D=A[M+2];u.push(R,b,b,D,D,R)}}else{const A=g.array;S=g.version;for(let M=0,T=A.length/3-1;M<T;M+=3){const R=M+0,b=M+1,D=M+2;u.push(R,b,b,D,D,R)}}const m=new(g.count>=65535?Oc:Nc)(u,1);m.version=S;const p=s.get(f);p&&e.remove(p),s.set(f,m)}function d(f){const u=s.get(f);if(u){const h=f.index;h!==null&&u.version<h.version&&c(f)}else c(f);return s.get(f)}return{get:o,update:l,getWireframeAttribute:d}}function jg(t,e,n){let i;function r(f){i=f}let s,a;function o(f){s=f.type,a=f.bytesPerElement}function l(f,u){t.drawElements(i,u,s,f*a),n.update(u,i,1)}function c(f,u,h){h!==0&&(t.drawElementsInstanced(i,u,s,f*a,h),n.update(u,i,h))}function d(f,u,h){if(h===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,u,0,s,f,0,h);let S=0;for(let m=0;m<h;m++)S+=u[m];n.update(S,i,1)}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=d}function Kg(t){const e={geometries:0,textures:0},n={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,a,o){switch(n.calls++,a){case t.TRIANGLES:n.triangles+=o*(s/3);break;case t.LINES:n.lines+=o*(s/2);break;case t.LINE_STRIP:n.lines+=o*(s-1);break;case t.LINE_LOOP:n.lines+=o*s;break;case t.POINTS:n.points+=o*s;break;default:$e("WebGLInfo: Unknown draw mode:",a);break}}function r(){n.calls=0,n.triangles=0,n.points=0,n.lines=0}return{memory:e,render:n,programs:null,autoReset:!0,reset:r,update:i}}function qg(t,e,n){const i=new WeakMap,r=new ht;function s(a,o,l){const c=a.morphTargetInfluences,d=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,f=d!==void 0?d.length:0;let u=i.get(o);if(u===void 0||u.count!==f){let y=function(){D.dispose(),i.delete(o),o.removeEventListener("dispose",y)};u!==void 0&&u.texture.dispose();const h=o.morphAttributes.position!==void 0,g=o.morphAttributes.normal!==void 0,S=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],p=o.morphAttributes.normal||[],A=o.morphAttributes.color||[];let M=0;h===!0&&(M=1),g===!0&&(M=2),S===!0&&(M=3);let T=o.attributes.position.count*M,R=1;T>e.maxTextureSize&&(R=Math.ceil(T/e.maxTextureSize),T=e.maxTextureSize);const b=new Float32Array(T*R*4*f),D=new Uc(b,T,R,f);D.type=cn,D.needsUpdate=!0;const v=M*4;for(let L=0;L<f;L++){const w=m[L],O=p[L],W=A[L],Y=T*R*4*L;for(let U=0;U<w.count;U++){const z=U*v;h===!0&&(r.fromBufferAttribute(w,U),b[Y+z+0]=r.x,b[Y+z+1]=r.y,b[Y+z+2]=r.z,b[Y+z+3]=0),g===!0&&(r.fromBufferAttribute(O,U),b[Y+z+4]=r.x,b[Y+z+5]=r.y,b[Y+z+6]=r.z,b[Y+z+7]=0),S===!0&&(r.fromBufferAttribute(W,U),b[Y+z+8]=r.x,b[Y+z+9]=r.y,b[Y+z+10]=r.z,b[Y+z+11]=W.itemSize===4?r.w:1)}}u={count:f,texture:D,size:new Se(T,R)},i.set(o,u),o.addEventListener("dispose",y)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(t,"morphTexture",a.morphTexture,n);else{let h=0;for(let S=0;S<c.length;S++)h+=c[S];const g=o.morphTargetsRelative?1:1-h;l.getUniforms().setValue(t,"morphTargetBaseInfluence",g),l.getUniforms().setValue(t,"morphTargetInfluences",c)}l.getUniforms().setValue(t,"morphTargetsTexture",u.texture,n),l.getUniforms().setValue(t,"morphTargetsTextureSize",u.size)}return{update:s}}function Jg(t,e,n,i,r){let s=new WeakMap;function a(c){const d=r.render.frame,f=c.geometry,u=e.get(c,f);if(s.get(u)!==d&&(e.update(u),s.set(u,d)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),s.get(c)!==d&&(n.update(c.instanceMatrix,t.ARRAY_BUFFER),c.instanceColor!==null&&n.update(c.instanceColor,t.ARRAY_BUFFER),s.set(c,d))),c.isSkinnedMesh){const h=c.skeleton;s.get(h)!==d&&(h.update(),s.set(h,d))}return u}function o(){s=new WeakMap}function l(c){const d=c.target;d.removeEventListener("dispose",l),i.releaseStatesOfObject(d),n.remove(d.instanceMatrix),d.instanceColor!==null&&n.remove(d.instanceColor)}return{update:a,dispose:o}}const Zg={[xc]:"LINEAR_TONE_MAPPING",[_c]:"REINHARD_TONE_MAPPING",[Ac]:"CINEON_TONE_MAPPING",[Sc]:"ACES_FILMIC_TONE_MAPPING",[Ec]:"AGX_TONE_MAPPING",[Tc]:"NEUTRAL_TONE_MAPPING",[Mc]:"CUSTOM_TONE_MAPPING"};function $g(t,e,n,i,r){const s=new bt(e,n,{type:t,depthBuffer:i,stencilBuffer:r,depthTexture:i?new ui(e,n):void 0}),a=new bt(e,n,{type:Un,depthBuffer:!1,stencilBuffer:!1}),o=new nn;o.setAttribute("position",new tn([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new tn([0,2,0,0,2,0],2));const l=new Xh({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),c=new Zt(o,l),d=new co(-1,1,1,-1,0,1);let f=null,u=null,h=!1,g,S=null,m=[],p=!1;this.setSize=function(A,M){s.setSize(A,M),a.setSize(A,M);for(let T=0;T<m.length;T++){const R=m[T];R.setSize&&R.setSize(A,M)}},this.setEffects=function(A){m=A,p=m.length>0&&m[0].isRenderPass===!0;const M=s.width,T=s.height;for(let R=0;R<m.length;R++){const b=m[R];b.setSize&&b.setSize(M,T)}},this.begin=function(A,M){if(h||A.toneMapping===_n&&m.length===0)return!1;if(S=M,M!==null){const T=M.width,R=M.height;(s.width!==T||s.height!==R)&&this.setSize(T,R)}return p===!1&&A.setRenderTarget(s),g=A.toneMapping,A.toneMapping=_n,!0},this.hasRenderPass=function(){return p},this.end=function(A,M){A.toneMapping=g,h=!0;let T=s,R=a;for(let b=0;b<m.length;b++){const D=m[b];if(D.enabled!==!1&&(D.render(A,R,T,M),D.needsSwap!==!1)){const v=T;T=R,R=v}}if(f!==A.outputColorSpace||u!==A.toneMapping){f=A.outputColorSpace,u=A.toneMapping,l.defines={},Ke.getTransfer(f)===rt&&(l.defines.SRGB_TRANSFER="");const b=Zg[u];b&&(l.defines[b]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=T.texture,A.setRenderTarget(S),A.render(c,d),S=null,h=!1},this.isCompositing=function(){return h},this.dispose=function(){s.depthTexture&&s.depthTexture.dispose(),s.dispose(),a.dispose(),o.dispose(),l.dispose()}}const Jc=new Dt,ka=new ui(1,1),Zc=new Uc,$c=new oh,eu=new Hc,El=[],Tl=[],bl=new Float32Array(16),yl=new Float32Array(9),Cl=new Float32Array(4);function Vi(t,e,n){const i=t[0];if(i<=0||i>0)return t;const r=e*n;let s=El[r];if(s===void 0&&(s=new Float32Array(r),El[r]=s),e!==0){i.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=n,t[a].toArray(s,o)}return s}function Pt(t,e){if(t.length!==e.length)return!1;for(let n=0,i=t.length;n<i;n++)if(t[n]!==e[n])return!1;return!0}function It(t,e){for(let n=0,i=e.length;n<i;n++)t[n]=e[n]}function as(t,e){let n=Tl[e];n===void 0&&(n=new Int32Array(e),Tl[e]=n);for(let i=0;i!==e;++i)n[i]=t.allocateTextureUnit();return n}function ev(t,e){const n=this.cache;n[0]!==e&&(t.uniform1f(this.addr,e),n[0]=e)}function tv(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2f(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(Pt(n,e))return;t.uniform2fv(this.addr,e),It(n,e)}}function nv(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3f(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else if(e.r!==void 0)(n[0]!==e.r||n[1]!==e.g||n[2]!==e.b)&&(t.uniform3f(this.addr,e.r,e.g,e.b),n[0]=e.r,n[1]=e.g,n[2]=e.b);else{if(Pt(n,e))return;t.uniform3fv(this.addr,e),It(n,e)}}function iv(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4f(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(Pt(n,e))return;t.uniform4fv(this.addr,e),It(n,e)}}function rv(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(Pt(n,e))return;t.uniformMatrix2fv(this.addr,!1,e),It(n,e)}else{if(Pt(n,i))return;Cl.set(i),t.uniformMatrix2fv(this.addr,!1,Cl),It(n,i)}}function sv(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(Pt(n,e))return;t.uniformMatrix3fv(this.addr,!1,e),It(n,e)}else{if(Pt(n,i))return;yl.set(i),t.uniformMatrix3fv(this.addr,!1,yl),It(n,i)}}function av(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(Pt(n,e))return;t.uniformMatrix4fv(this.addr,!1,e),It(n,e)}else{if(Pt(n,i))return;bl.set(i),t.uniformMatrix4fv(this.addr,!1,bl),It(n,i)}}function ov(t,e){const n=this.cache;n[0]!==e&&(t.uniform1i(this.addr,e),n[0]=e)}function lv(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2i(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(Pt(n,e))return;t.uniform2iv(this.addr,e),It(n,e)}}function cv(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3i(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else{if(Pt(n,e))return;t.uniform3iv(this.addr,e),It(n,e)}}function uv(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4i(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(Pt(n,e))return;t.uniform4iv(this.addr,e),It(n,e)}}function dv(t,e){const n=this.cache;n[0]!==e&&(t.uniform1ui(this.addr,e),n[0]=e)}function fv(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2ui(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(Pt(n,e))return;t.uniform2uiv(this.addr,e),It(n,e)}}function hv(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3ui(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else{if(Pt(n,e))return;t.uniform3uiv(this.addr,e),It(n,e)}}function pv(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4ui(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(Pt(n,e))return;t.uniform4uiv(this.addr,e),It(n,e)}}function mv(t,e,n){const i=this.cache,r=n.allocateTextureUnit();i[0]!==r&&(t.uniform1i(this.addr,r),i[0]=r);let s;this.type===t.SAMPLER_2D_SHADOW?(ka.compareFunction=n.isReversedDepthBuffer()?io:no,s=ka):s=Jc,n.setTexture2D(e||s,r)}function gv(t,e,n){const i=this.cache,r=n.allocateTextureUnit();i[0]!==r&&(t.uniform1i(this.addr,r),i[0]=r),n.setTexture3D(e||$c,r)}function vv(t,e,n){const i=this.cache,r=n.allocateTextureUnit();i[0]!==r&&(t.uniform1i(this.addr,r),i[0]=r),n.setTextureCube(e||eu,r)}function xv(t,e,n){const i=this.cache,r=n.allocateTextureUnit();i[0]!==r&&(t.uniform1i(this.addr,r),i[0]=r),n.setTexture2DArray(e||Zc,r)}function _v(t){switch(t){case 5126:return ev;case 35664:return tv;case 35665:return nv;case 35666:return iv;case 35674:return rv;case 35675:return sv;case 35676:return av;case 5124:case 35670:return ov;case 35667:case 35671:return lv;case 35668:case 35672:return cv;case 35669:case 35673:return uv;case 5125:return dv;case 36294:return fv;case 36295:return hv;case 36296:return pv;case 35678:case 36198:case 36298:case 36306:case 35682:return mv;case 35679:case 36299:case 36307:return gv;case 35680:case 36300:case 36308:case 36293:return vv;case 36289:case 36303:case 36311:case 36292:return xv}}function Av(t,e){t.uniform1fv(this.addr,e)}function Sv(t,e){const n=Vi(e,this.size,2);t.uniform2fv(this.addr,n)}function Mv(t,e){const n=Vi(e,this.size,3);t.uniform3fv(this.addr,n)}function Ev(t,e){const n=Vi(e,this.size,4);t.uniform4fv(this.addr,n)}function Tv(t,e){const n=Vi(e,this.size,4);t.uniformMatrix2fv(this.addr,!1,n)}function bv(t,e){const n=Vi(e,this.size,9);t.uniformMatrix3fv(this.addr,!1,n)}function yv(t,e){const n=Vi(e,this.size,16);t.uniformMatrix4fv(this.addr,!1,n)}function Cv(t,e){t.uniform1iv(this.addr,e)}function wv(t,e){t.uniform2iv(this.addr,e)}function Rv(t,e){t.uniform3iv(this.addr,e)}function Dv(t,e){t.uniform4iv(this.addr,e)}function Pv(t,e){t.uniform1uiv(this.addr,e)}function Iv(t,e){t.uniform2uiv(this.addr,e)}function Lv(t,e){t.uniform3uiv(this.addr,e)}function Uv(t,e){t.uniform4uiv(this.addr,e)}function Bv(t,e,n){const i=this.cache,r=e.length,s=as(n,r);Pt(i,s)||(t.uniform1iv(this.addr,s),It(i,s));let a;this.type===t.SAMPLER_2D_SHADOW?a=ka:a=Jc;for(let o=0;o!==r;++o)n.setTexture2D(e[o]||a,s[o])}function Fv(t,e,n){const i=this.cache,r=e.length,s=as(n,r);Pt(i,s)||(t.uniform1iv(this.addr,s),It(i,s));for(let a=0;a!==r;++a)n.setTexture3D(e[a]||$c,s[a])}function Nv(t,e,n){const i=this.cache,r=e.length,s=as(n,r);Pt(i,s)||(t.uniform1iv(this.addr,s),It(i,s));for(let a=0;a!==r;++a)n.setTextureCube(e[a]||eu,s[a])}function Ov(t,e,n){const i=this.cache,r=e.length,s=as(n,r);Pt(i,s)||(t.uniform1iv(this.addr,s),It(i,s));for(let a=0;a!==r;++a)n.setTexture2DArray(e[a]||Zc,s[a])}function zv(t){switch(t){case 5126:return Av;case 35664:return Sv;case 35665:return Mv;case 35666:return Ev;case 35674:return Tv;case 35675:return bv;case 35676:return yv;case 5124:case 35670:return Cv;case 35667:case 35671:return wv;case 35668:case 35672:return Rv;case 35669:case 35673:return Dv;case 5125:return Pv;case 36294:return Iv;case 36295:return Lv;case 36296:return Uv;case 35678:case 36198:case 36298:case 36306:case 35682:return Bv;case 35679:case 36299:case 36307:return Fv;case 35680:case 36300:case 36308:case 36293:return Nv;case 36289:case 36303:case 36311:case 36292:return Ov}}class Gv{constructor(e,n,i){this.id=e,this.addr=i,this.cache=[],this.type=n.type,this.setValue=_v(n.type)}}class Hv{constructor(e,n,i){this.id=e,this.addr=i,this.cache=[],this.type=n.type,this.size=n.size,this.setValue=zv(n.type)}}class kv{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,n,i){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,n[o.id],i)}}}const Ws=/(\w+)(\])?(\[|\.)?/g;function wl(t,e){t.seq.push(e),t.map[e.id]=e}function Vv(t,e,n){const i=t.name,r=i.length;for(Ws.lastIndex=0;;){const s=Ws.exec(i),a=Ws.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===r){wl(n,c===void 0?new Gv(o,t,e):new Hv(o,t,e));break}else{let f=n.map[o];f===void 0&&(f=new kv(o),wl(n,f)),n=f}}}class Xr{constructor(e,n){this.seq=[],this.map={};const i=e.getProgramParameter(n,e.ACTIVE_UNIFORMS);for(let a=0;a<i;++a){const o=e.getActiveUniform(n,a),l=e.getUniformLocation(n,o.name);Vv(o,l,this)}const r=[],s=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(a):s.push(a);r.length>0&&(this.seq=r.concat(s))}setValue(e,n,i,r){const s=this.map[n];s!==void 0&&s.setValue(e,i,r)}setOptional(e,n,i){const r=n[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,n,i,r){for(let s=0,a=n.length;s!==a;++s){const o=n[s],l=i[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,r)}}static seqWithValue(e,n){const i=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in n&&i.push(a)}return i}}function Rl(t,e,n){const i=t.createShader(e);return t.shaderSource(i,n),t.compileShader(i),i}const Wv=37297;let Xv=0;function Yv(t,e){const n=t.split(`
`),i=[],r=Math.max(e-6,0),s=Math.min(e+6,n.length);for(let a=r;a<s;a++){const o=a+1;i.push(`${o===e?">":" "} ${o}: ${n[a]}`)}return i.join(`
`)}const Dl=new Be;function Qv(t){Ke._getMatrix(Dl,Ke.workingColorSpace,t);const e=`mat3( ${Dl.elements.map(n=>n.toFixed(4))} )`;switch(Ke.getTransfer(t)){case Jr:return[e,"LinearTransferOETF"];case rt:return[e,"sRGBTransferOETF"];default:return De("WebGLProgram: Unsupported color space: ",t),[e,"LinearTransferOETF"]}}function Pl(t,e,n){const i=t.getShaderParameter(e,t.COMPILE_STATUS),s=(t.getShaderInfoLog(e)||"").trim();if(i&&s==="")return"";const a=/ERROR: 0:(\d+)/.exec(s);if(a){const o=parseInt(a[1]);return n.toUpperCase()+`

`+s+`

`+Yv(t.getShaderSource(e),o)}else return s}function jv(t,e){const n=Qv(e);return[`vec4 ${t}( vec4 value ) {`,`	return ${n[1]}( vec4( value.rgb * ${n[0]}, value.a ) );`,"}"].join(`
`)}const Kv={[xc]:"Linear",[_c]:"Reinhard",[Ac]:"Cineon",[Sc]:"ACESFilmic",[Ec]:"AgX",[Tc]:"Neutral",[Mc]:"Custom"};function qv(t,e){const n=Kv[e];return n===void 0?(De("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+t+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+t+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const zr=new B;function Jv(){Ke.getLuminanceCoefficients(zr);const t=zr.x.toFixed(4),e=zr.y.toFixed(4),n=zr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${t}, ${e}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Zv(t){return[t.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",t.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(tr).join(`
`)}function $v(t){const e=[];for(const n in t){const i=t[n];i!==!1&&e.push("#define "+n+" "+i)}return e.join(`
`)}function e0(t,e){const n={},i=t.getProgramParameter(e,t.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const s=t.getActiveAttrib(e,r),a=s.name;let o=1;s.type===t.FLOAT_MAT2&&(o=2),s.type===t.FLOAT_MAT3&&(o=3),s.type===t.FLOAT_MAT4&&(o=4),n[a]={type:s.type,location:t.getAttribLocation(e,a),locationSize:o}}return n}function tr(t){return t!==""}function Il(t,e){const n=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return t.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,n).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Ll(t,e){return t.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const t0=/^[ \t]*#include +<([\w\d./]+)>/gm;function Va(t){return t.replace(t0,i0)}const n0=new Map;function i0(t,e){let n=we[e];if(n===void 0){const i=n0.get(e);if(i!==void 0)n=we[i],De('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return Va(n)}const r0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Ul(t){return t.replace(r0,s0)}function s0(t,e,n,i){let r="";for(let s=parseInt(e);s<parseInt(n);s++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Bl(t){let e=`precision ${t.precision} float;
...
#define LOW_PRECISION`),e}const a0={[Gr]:"SHADOWMAP_TYPE_PCF",[er]:"SHADOWMAP_TYPE_VSM"};function o0(t){return a0[t.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const l0={[oi]:"ENVMAP_TYPE_CUBE",[Ui]:"ENVMAP_TYPE_CUBE",[rs]:"ENVMAP_TYPE_CUBE_UV"};function c0(t){return t.envMap===!1?"ENVMAP_TYPE_CUBE":l0[t.envMapMode]||"ENVMAP_TYPE_CUBE"}const u0={[Ui]:"ENVMAP_MODE_REFRACTION"};function d0(t){return t.envMap===!1?"ENVMAP_MODE_REFLECTION":u0[t.envMapMode]||"ENVMAP_MODE_REFLECTION"}const f0={[vc]:"ENVMAP_BLENDING_MULTIPLY",[Hf]:"ENVMAP_BLENDING_MIX",[kf]:"ENVMAP_BLENDING_ADD"};function h0(t){return t.envMap===!1?"ENVMAP_BLENDING_NONE":f0[t.combine]||"ENVMAP_BLENDING_NONE"}function p0(t){const e=t.envMapCubeUVHeight;if(e===null)return null;const n=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),112)),texelHeight:i,maxMip:n}}function m0(t,e,n,i){const r=t.getContext(),s=n.defines;let a=n.vertexShader,o=n.fragmentShader;const l=o0(n),c=c0(n),d=d0(n),f=h0(n),u=p0(n),h=Zv(n),g=$v(s),S=r.createProgram();let m,p,A=n.glslVersion?"#version "+n.glslVersion+`
...
#include <colorspace_fragment>
}`,Yx="uniform vec2 texelSize;varying vec2 vUv;varying vec2 vUv00;varying vec2 vUv01;varying vec2 vUv02;varying vec2 vUv03;varying vec2 vUv04;varying vec2 vUv05;varying vec2 vUv06;varying vec2 vUv07;varying vec2 vUv08;varying vec2 vUv09;varying vec2 vUv10;varying vec2 vUv11;void main(){vUv=position.xy*0.5+0.5;vUv00=vUv+texelSize*vec2(-1.0,1.0);vUv01=vUv+texelSize*vec2(1.0,1.0);vUv02=vUv+texelSize*vec2(-1.0,-1.0);vUv03=vUv+texelSize*vec2(1.0,-1.0);vUv04=vUv+texelSize*vec2(-2.0,2.0);vUv05=vUv+texelSize*vec2(0.0,2.0);vUv06=vUv+texelSize*vec2(2.0,2.0);vUv07=vUv+texelSize*vec2(-2.0,0.0);vUv08=vUv+texelSize*vec2(2.0,0.0);vUv09=vUv+texelSize*vec2(-2.0,-2.0);vUv10=vUv+texelSize*vec2(0.0,-2.0);vUv11=vUv+texelSize*vec2(2.0,-2.0);gl_Position=vec4(position.xy,1.0,1.0);}",Qx=class extends Ct{constructor(){super({name:"DownsamplingMaterial",uniforms:{inputBuffer:new ke(null),texelSize:new ke(new Se)},blending:Nt,toneMapped:!1,depthWrite:!1,depthTest:!1,fragmentShader:Xx,vertexShader:Yx})}set inputBuffer(t){this.uniforms.inputBuffer.value=t}setSize(t,e){this.uniforms.texelSize.value.set(1/t,1/e)}},jx=`#ifdef FRAMEBUFFER_PRECISION_HIGH
...
#endif
}`,i_=`uniform vec2 texelSize;varying vec2 vUv;varying vec2 vUv0;varying vec2 vUv1;
#if EDGE_DETECTION_MODE != 0
varying vec2 vUv2;varying vec2 vUv3;varying vec2 vUv4;varying vec2 vUv5;
#endif
...
`}if(c+=i+`
`,r!==null&&(u+=r+`
`),l.set(tt.FRAGMENT_HEAD,c),l.set(tt.FRAGMENT_MAIN_UV,d),l.set(tt.FRAGMENT_MAIN_IMAGE,f),l.set(tt.VERTEX_HEAD,u),l.set(tt.VERTEX_MAIN_SUPPORT,h),e.extensions!==null)for(const A of e.extensions)n.extensions.add(A)}}var Yl=class extends rn{constructor(t,...e){super("EffectPass"),this.fullscreenMaterial=new h_(null,null,null,t),this.listener=n=>this.handleEvent(n),this.effects=[],this.setEffects(e),this.skipRendering=!1,this.minTime=1,this.maxTime=Number.POSITIVE_INFINITY,this.timeScale=1}set mainScene(t){for(const e of this.effects)e.mainScene=t}set mainCamera(t){this.fullscreenMaterial.copyCameraSettings(t);for(const e of this.effects)e.mainCamera=t}get encodeOutput(){return this.fullscreenMaterial.encodeOutput}set encodeOutput(t){this.fullscreenMaterial.encodeOutput=t}get dithering(){return this.fullscreenMaterial.dithering}set dithering(t){const e=this.fullscreenMaterial;e.dithering=t,e.needsUpdate=!0}setEffects(t){for(const e of this.effects)e.removeEventListener("change",this.listener);this.effects=t.sort((e,n)=>n.attributes-e.attributes);for(const e of this.effects)e.addEventListener("change",this.listener)}updateMaterial(){const t=new nx;let e=0;for(const a of this.effects)if(a.blendMode.blendFunction===We.DST)t.attributes|=a.getAttributes()&In.DEPTH;else{if((t.attributes&a.getAttributes()&In.CONVOLUTION)!==0)throw new Error(`Convolution effects cannot be merged (${a.name})`);p_("e"+e++,a,t)}let n=t.shaderParts.get(tt.FRAGMENT_HEAD),i=t.shaderParts.get(tt.FRAGMENT_MAIN_IMAGE),r=t.shaderParts.get(tt.FRAGMENT_MAIN_UV);const s=/\bblend\b/g;for(const a of t.blendModes.values())n+=a.getShaderCode().replace(s,`blend${a.blendFunction}`)+`
...
uniform float uBrokenLinesLengthPercentage;`,M_=`
  ...
  brokenLines = mix(brokenLines, sideLines, uv.x);`,au=`
#define USE_FOG
${we.fog_pars_fragment}
...
void main() {
  ...
  ${we.fog_fragment}
}`,E_=au.replace("#include <roadMarkings_fragment>","").replace("#include <roadMarkings_vars>",""),T_=au.replace("#include <roadMarkings_fragment>",M_).replace("#include <roadMarkings_vars>",S_),b_=`
#define USE_FOG
uniform float uTime;
${we.fog_pars_vertex}
uniform float uTravelLength;
